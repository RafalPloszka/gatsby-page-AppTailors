...
const Navbar = ({ links }) => {
  ...
  const logoSize = shrink ? 32 : 52;

  return (
    <nav id="index" className={classes}>
      <div className={styles.container}>
        <div className={styles.navItem}>
          <Link to="/" className={classNames(styles.link, styles.cursorPointer)}>
            <svg xmlns="http://www.w3.org/2000/svg" width={logoSize} height={logoSize} viewBox="0 0 51.544 58.692">
